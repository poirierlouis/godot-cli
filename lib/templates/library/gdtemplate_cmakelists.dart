...
class GDTemplateCMakeLists extends GDTemplateFile {
  @override
  String get fileName => "CMakeLists.txt";
...
set_property(TARGET \${PROJECT_NAME} PROPERTY OUTPUT_NAME "gd${data.libraryName}")
""";
  }
}
