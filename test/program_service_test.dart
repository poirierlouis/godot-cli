...
void main() {
  group("ProgramService", () {
    ...
    test(".getVersion(content) while content contains no version number should return <null>.", () async {
      final version = ProgramService.getVersion("Generated 5 paragraphs, 448 words, 3019 bytes of Lorem Ipsum");

      expect(version, null);
    });

    test(".getVersion(content) while content contains '2.19.1' should return SemVer(2, 19, 1).", () async {
